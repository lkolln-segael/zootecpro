  ...
  public class ProduccionController : Controller
  {
    ...
    private async Task<Empresa?> GetEmpresaAsync()
    {
      ...
      return await _context.Empresas.FirstOrDefaultAsync(e => e.usuarioID == usuarioId
          || usuarioId != null && e.Colaboradors.Select(e => e.idUsuario).Contains(usuarioId.Value));
    }
    // GET: Produccion
    public async Task<IActionResult> Index(DateTime? desde, DateTime? hasta, int? idAnimal)
    {
      ...
      var establo = await _context.Establos.FirstOrDefaultAsync(e =>
          empresa != null &&
      ...
      .Where(r => usuario != null && usuario.RolId == 1 ||
          establo != null && r.idAnimalNavigation.idHatoNavigation.EstabloId == establo.Id)
      .AsQueryable();
