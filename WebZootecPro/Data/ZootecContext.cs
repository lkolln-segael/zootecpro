...
public partial class ZootecContext : DbContext
{
    ...
    public virtual DbSet<Inseminador> Inseminadors { get; set; }
    ...
    protected override void OnModelCreating(ModelBuilder modelBuilder)
    {
        ...
        modelBuilder.Entity<Inseminador>(entity =>
        {
            entity.HasOne(d => d.Empresa).WithMany(p => p.Inseminadors)
                .OnDelete(DeleteBehavior.ClientSetNull)
                .HasConstraintName("FK_Inseminador_Empresa");
        });
        ...
        {
            entity.HasOne(d => d.IdInseminadorNavigation).WithMany(p => p.Prenezs).HasConstraintName("FK_Prenez_Inseminador");
